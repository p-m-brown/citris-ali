...
where _n_ is the total sample size, _G_ is the total number of outcomes, _δij=1_ if patient ifailed on outcome _j_ and _0_ otherwise, and _r_ij_ is the rank for patient _i_ on outcome _j_ (rank 1 being the worst response and nbeing the best). <br>
